...
const AddSymbolForm = ({portfolioName}) => {
    const dispatch = useDispatch()
    const portfolios = useSelector(state => state.portfolios)
    const isLoading = portfolios.isLoadingSymbols
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(addSymbol(amount, symbol, portfolioName));
        setSymbol('');
        setAmount(0);
    };
                        ...
                        {isLoading ? (
                            ...
                            <BaseContainer>
                                ...
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <ButtonsContainer>
                                        <button type="submit" disabled={symbol.length < 1 || isLegalInput}
